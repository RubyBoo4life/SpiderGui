...
Raq.Name = "Raq"
Raq.Parent = SpiderGui
Raq.BackgroundColor3 = Color3.fromRGB(89, 89, 89)
Raq.Position = UDim2.new(0.74479568, 0, 0.480981588, 0)
Raq.Size = UDim2.new(0, 311, 0, 214)
Raq.Active = true

skraef.Name = "skraef"
skraef.Parent = Raq
skraef.BackgroundColor3 = Color3.fromRGB(89, 89, 89)
skraef.Position = UDim2.new(0, 0, -0.233644858, 0)
skraef.Size = UDim2.new(0, 311, 0, 50)
skraef.Font = Enum.Font.GothamBlack
skraef.Text = "Log In"
skraef.TextColor3 = Color3.fromRGB(0, 0, 0)
skraef.TextScaled = true
skraef.TextSize = 14.000
skraef.TextWrapped = true

ska.Name = "ska"
ska.Parent = Raq
ska.BackgroundColor3 = Color3.fromRGB(139, 139, 139)
ska.Position = UDim2.new(0.176848873, 0, 0.144859806, 0)
ska.Size = UDim2.new(0, 200, 0, 50)
ska.Font = Enum.Font.GothamBlack
ska.Text = "Username here"
ska.TextColor3 = Color3.fromRGB(0, 0, 0)
ska.TextScaled = true
ska.TextSize = 14.000
ska.TextWrapped = true

resk.Name = "resk"
resk.Parent = Raq
resk.BackgroundColor3 = Color3.fromRGB(139, 139, 139)
resk.Position = UDim2.new(0.176848873, 0, 0.453271031, 0)
resk.Size = UDim2.new(0, 200, 0, 50)
resk.Font = Enum.Font.GothamBlack
resk.Text = "Password here"
resk.TextColor3 = Color3.fromRGB(0, 0, 0)
resk.TextScaled = true
resk.TextSize = 14.000
resk.TextWrapped = true

raspels.Name = "raspels"
raspels.Parent = Raq
raspels.BackgroundColor3 = Color3.fromRGB(194, 194, 194)
raspels.Position = UDim2.new(0, 55, 0, 156)
raspels.Size = UDim2.new(0, 200, 0, 50)
raspels.Font = Enum.Font.GothamBlack
raspels.Text = "Log In"
raspels.TextColor3 = Color3.fromRGB(0, 0, 0)
raspels.TextScaled = true
raspels.TextSize = 14.000
raspels.TextWrapped = true
raspels.MouseButton1Down:connect(function()
	if ska.Text == "RubyBoo" and resk.Text == "8920" then
		Raq.Visible = false
		Main.Visible = true
	end
end)
